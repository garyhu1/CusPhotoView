...
import com.garyhu.imagesliderdemo.photoview.HackyViewPager;
...
public class NewsViewPagerActivity extends AppCompatActivity {
    ...
    private void initParams() {
        picture_iv_index.setText("1/" + cars.length + descs[0]);
        // 绑定适配器
    ...
    private class ViewPagerChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            //设置文字
            picture_iv_index.setText((arg0 + 1) + "/" + cars.length + " " + descs[0+arg0]);
        }
