...
import com.garyhu.imagesliderdemo.base.BaseActivity;
...
public class ChoosePicActivity extends BaseActivity {
    ...
    private void initEvent() {
        ...
        findViewById(R.id.tv_clear).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ChoosePicActivity.this, "清除成功~", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void openPs() {
        ...
        checkPermission(new CheckPermListener() {
            ...
            public void agreeAllPermission() {
                PSConfigUtil.getInstance().showSelector(ChoosePicActivity.this, REQUEST_CODE_1, selectedImages);
            }
    ...
    private void openCamera() {
        ...
        checkPermission(new CheckPermListener() {
            @Override
            public void agreeAllPermission() {
                PSConfigUtil.getInstance().showTakePhotoAndCrop(ChoosePicActivity.this, REQUEST_CODE_2);
            }
        }, "拍照需要使用相机权限", perms);
    }
